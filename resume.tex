...
\tag{Swift} \tag{SwiftUI} \tag{UIKit} \tag{Code Review}
...
The biggest challenge was learning Vue, as it was a completely foreign the framework.}
...
Developed JavaScript project simulating a number of particles, or dots, applying forces on each other that can form interesting, natural looking structures. Pretty and entertaining.}
